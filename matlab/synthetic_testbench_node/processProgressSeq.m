  ...
  if ~isfield(t, 'ftag2_num_tags_detected'),
    ...
    if t.ftag2_num_tags_detected == 0,
      ...
      ftag2_vec = [ ...
        ...
        angularDiff(tag_pitch_rad, ftag2_pitch_rad, 2*pi)/radians, ...
        angularDiff(tag_yaw_rad, ftag2_yaw_rad, 2*pi)/radians, ...
        angularDiff(tag_roll_rad, ftag2_roll_rad, 2*pi)/radians, ...
        ];
